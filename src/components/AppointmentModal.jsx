              ...
              <div className="p-8 overflow-y-auto" style={{ scrollbarWidth: 'thin' }}>
                {isSuccess ? (
                  ...
                  >
                    ...
                    <button onClick={onClose} className="px-6 py-3 bg-gray-100 text-gray-700 font-bold rounded-full hover:bg-gray-200 transition-colors">
                      Done
                    </button>
                  </motion.div>
                ) : (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-gray-700 ml-1">Condition / Service Setup</label>
                    ...
                    <div className="pt-2 shrink-0">
                      <button 
                        ...
                        className="w-full bg-brand-orange text-white rounded-2xl px-8 py-4 font-bold text-[15px] hover:bg-[#15202B] hover:shadow-lg hover:-translate-y-1 transition-all duration-300 disabled:opacity-70 disabled:hover:transform-none"
                      >
